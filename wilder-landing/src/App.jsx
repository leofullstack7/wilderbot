...
import logoUrl from "/vite.svg"; // reemplázalo por tu logo si ya lo tienes

// 👇 helper para mandar faq_origen limpio
function slugify(s) {
  return s
    .toLowerCase()
...
export default function App() {
  ...
  // ⬇️ antes era string; ahora guardamos texto y slug para faq_origen
  ...
  function toggleChat() {
    setPrefill({ text: "", faq: "" }); // no mandar texto si es simple toggle
    setChatOpen(v => !v);
  }
      ...
      <section className="container mx-auto px-4 pb-8 md:pb-16">
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {[
            {
              t: "Propón una idea",
              d: "Describe la propuesta, su impacto y el lugar. Te orientamos para presentarla.",
              i: "💡",
            },
            {
              t: "Reporta un problema",
              d: "Indícanos qué sucede y dónde. Escalamos al equipo o entidad correspondiente.",
              i: "📍",
            },
            {
              t: "Reconoce a tu comunidad",
              d: "Cuéntanos buenas prácticas o liderazgos que debamos visibilizar.",
              i: "🤝",
            },
          ].map((c, idx) => (
            <div
